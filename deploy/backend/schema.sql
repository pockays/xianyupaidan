...
('admin', '$2b$10$7Ck08z9bHHdAcOKX4ibHUe6b7TtnJxZ0XF0rkPx3uEBgP6c1ybv9G')
ON DUPLICATE KEY UPDATE username = username;

-- 初始化默认管理员 (密码: admin123)
INSERT INTO admin (tenant_id, username, password_hash, email, status) VALUES
('default', 'manager', '$2b$10$7Ck08z9bHHdAcOKX4ibHUe6b7TtnJxZ0XF0rkPx3uEBgP6c1ybv9G', 'manager@qq.com', 1)
ON DUPLICATE KEY UPDATE username = username;
